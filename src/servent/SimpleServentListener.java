			...
			try {
				...
				switch (clientMessage.getMessageType()) {
					...
					case WELCOME:
						...
						break;
					case READY:
						messageHandler = new ReadyHandler(clientMessage);
						break;
					case STATUS_ASK:
						messageHandler = new StatusAskHandler(clientMessage);
						break;
					case STATUS_SPECIFIC:
						messageHandler = new StatausSpecificHandler(clientMessage);
						break;
					case STATUS_REPLY:
						messageHandler = new StatusReplyHandler(clientMessage);
						break;
					case RESULT_ASK:
						messageHandler = new ResultAskHandler(clientMessage);
						break;
					case RESULT_SPECIFIC:
						messageHandler = new ResultSpecificHandler(clientMessage);
						break;
					case RESULT_REPLY:
						messageHandler = new ResultReplyHandler(clientMessage);
						break;
					case NUMS:
						messageHandler = new NumsHandler(clientMessage);
						break;
					case IDLE:
						messageHandler = new NumsHandler(clientMessage);
						break;
					case QUIT_JOB:
						messageHandler = new QuitJobHandler(clientMessage);
						break;
					case NEIGHBOUR_QUIT:
						messageHandler = new NeighbourQuitHandler(clientMessage);
						break;
					case POISON:
						break;
				}
